...
import 'package:twenty_four_hours/ChipTile.dart';
import 'package:twenty_four_hours/DatePicker.dart';
import 'package:image_picker/image_picker.dart';
import 'package:twenty_four_hours/ProfileImage.dart';
import 'package:twenty_four_hours/Register.dart';
...
class RegisterForm extends StatefulWidget {
  ...
  RegisterForm({Key key,this.title
   }):super(key:key);
  final String title;
...
class _CreateRegisterForm extends State<RegisterForm> {
 ...
 // FirebaseAuth Fauth;
  ...
  void saveUserInformation(Register userInfo)async{
...
return new AlertDialog(
      content: new Center(
            ...
            new Row(
              ...
              children: <Widget>[
                new ProfileImage(
                  ...
                  image: _image!=null?new FileImage(_image):new AssetImage('images/hbot_wave.png'),
                  width: 100.0,
                  height: 100.0,
        ...
        new Container(
          ...
          decoration: new BoxDecoration(
            ...
            new Text(
                'Congrats $fn,  We\'re Glad that You Joined us.',
            style: new TextStyle(
              fontFamily: 'Jua',
      ...
      actions: <Widget>[
        new FlatButton(onPressed: _sendMail, child: new Text('Gimme a Tour',style: new TextStyle(color: Colors.blue),)),
       // new FlatButton(onPressed: _sendSMS, child: new Text('Send SMS',style: new TextStyle(color: Colors.blue),)),
        new FlatButton(onPressed: _sendMail, child: new Text('Take me Home',style: new TextStyle(color: Colors.green),)),
  ...
  Widget build(BuildContext context) {
    final List<Widget> choiceChips = _materials.map<Widget>((String name) {
      ...
      return new FilterChip(
        ...
        selected: _materials.contains(name) ? _selectedTools.contains(name) : false,
    ...
    snackbar = SnackBar(
      ...
      content: Text('Generated Username: $generatedUsername'),
    ...
    my_steps = [
      ...
      new Step(
        ...
        // Title of the Step
          ...
          title: new Text(isOneCompleted ? "Registered *" : "Register *",
            style: new TextStyle(
              color: isOneCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              ...
              children: <Widget>[
                ...
                new TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    icon: const Icon(
                        Icons.person, color: Colors.midnightTextPrimary),
                    ...
                    suffixIcon: new GestureDetector(
                      ...
                      child: new Icon(
                        Icons.assignment_ind, color: Colors.lightGreenAccent,),
                ...
                new TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      icon: new Icon(Icons.email,
                          color: _validEmail ? Colors.lightGreenAccent : Colors
                              .midnightTextPrimary),
                ...
                new TextFormField(
                  ...
                  decoration: new InputDecoration(
                    border: const UnderlineInputBorder(),
                    filled: false,
                    icon: _validPassword ? const Icon(
                        Icons.lock_open, color: Colors.green) : const Icon(
                        Icons.lock, color: Colors.midnightTextPrimary),

                    hintText: 'Enter Password',
                    labelText: "Password",
                    hintStyle: new TextStyle(fontFamily: 'Jua',
      ...
      new Step(
          ...
          title: new Text(isTwoCompleted ? fn + " " + sn +" *": "Full-Name *",
            style: new TextStyle(
              color: isTwoCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
      ...
      new Step(
          ...
          title: new Text(isThreeCompleted ? 'DOB: ' +
              new DateFormat.yMd('en_ISO').format(_fromDate) +
              ' (${new DateTime.now().year - _fromDate.year})' : "Birthday *",
            style: new TextStyle(
              color: isThreeCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
      ...
      new Step(
          ...
          title: new Text(isFourCompleted ? "Gender: $sex" : "Gender: Male *",
            style: new TextStyle(
              color: isFourCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
          ...
          content: new Column(
            children: <Widget>[
              ...
              new Text('Select Gender', style: new TextStyle(
                  color: Colors.midnightTextPrimary,
                  fontFamily: 'Jua',
                  fontSize: 16.0),
              ),
      ...
      new Step(
          ...
          title: new Text(
            ...
            style: new TextStyle(
              color: isFiveCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
                  ...
                  items: _values.map((String value) {
                    return new DropdownMenuItem(
                      ...
                      child: new Row(
                        ...
                        children: <Widget>[
                          new Icon(Icons.assistant_photo, color: Colors.blue,),
                          Text("${value}",
                              style: new TextStyle(
    ...
    title: new Text(isSixCompleted ? "Interests: ${_selectedTools.length} Selected":"Interests: None Selected",
    style: new TextStyle(
    color: isSixCompleted ? Colors.lightGreenAccent : Colors
        .lightBlueAccent,
    fontFamily: 'ExoLight',
    fontWeight: FontWeight.bold,
    fontSize: 18.0,
    ...
    new Padding(padding: const EdgeInsets.only(left: 6.0)),
    new Text('Select your interests', style: new TextStyle(
    color: Colors.midnightTextPrimary,
    fontFamily: 'Jua',
    fontSize: 16.0),
    ),
    new ChipTile(label: '', children: choiceChips),
      ...
      new Step(
          ...
          title: new Text(
            "Profile Pic",
            style: new TextStyle(
              color: isSevenCompleted ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
...
state:  isSixCompleted ? StepState.complete : StepState.editing,
      ...
      new Step(
          ...
          title: new Text(
            "Finalize",
            style: new TextStyle(
              color: isAllComplete ? Colors.lightGreenAccent : Colors
                  .lightBlueAccent,
              fontFamily: 'ExoLight',
              fontWeight: FontWeight.bold,
              fontSize: 18.0,
          ...
          content: new Container(
            ...
            child: new RaisedButton(onPressed: isAllComplete?sendEmail():null,
          ...
          color: Colors.green,
          child: new Text(isAllComplete?'I\'m Happy with everything ☺':'Oops you\'re not Done',
    style: new TextStyle(
              ...
              setState(() {
                ...
                // jump to the tapped step
               ...
               else if(step==6)
                  {
                    ...
                    username=_ucontroller.text;
                    password=_controller.text.replaceRange(1, _controller.text.length, '*');
                    ...
                    {
                      if(isOneCompleted&&isTwoCompleted&&isThreeCompleted&&isFourCompleted)
                        isAllComplete=true;
                    }
              });
...
class UsernameGenerator{
  ...
  String getUsername()
  {
    ...
    while(!(searchForVowels(username)&&(searchForConsonants(username))&&checkWordEfficiency(username)))
    {
  ...
  String insertNumber(String name) {
    ...
    if(randNumber<60)
    {
      finalUsername=finalUsername.replaceRange(pos, pos+1, randNumber.toString());
    }
    else {
    ...
    username=username.replaceRange(0, 1, username.substring(0,1).toUpperCase());
    return username;
