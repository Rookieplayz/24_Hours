...
import 'package:twenty_four_hours/LoginActivity.dart';
import 'package:twenty_four_hours/RegisterForm.dart';
import 'package:twenty_four_hours/colors.dart';
import 'dart:ui';
...
enum AppBarBehavior { normal, pinned, floating, snapping }
    ...
    class _RegisterActivity extends State<RegisterMain>    with TickerProviderStateMixin {
      ...
      void _select(Choice choice) {
        ...
        setState(() {
          ...
          print(choice.title);
          if(_selectedChoice.title=='Login')
          {
            _navTo(new LoginActivityMain());
          }
        });
      }
              ...
              return <Widget>[
                new SliverAppBar(
                        ...
                        PopupMenuItem<AppBarBehavior>(
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              ...
                              new IconButton(
                                icon: new Icon(
                                  choices[1].icon, color: Colors.white,),
                                color: Colors.white,
                              )
                            ],
                          ),
                  ...
                  flexibleSpace: new FlexibleSpaceBar(
                    ...
                    title: const Text('Welcome To 24 • Hours',
            ...
            body: new Container(
              ...
              child: new Container(
                  padding: const EdgeInsets.only(
                      top: 20.0, left: 16.0, right: 2.0),
                  height: 1000.0,
                  decoration: new BoxDecoration (
                      borderRadius: new BorderRadius.all(
                          new Radius.circular(15.0)),
                      color: Colors.midnight_main,
                      boxShadow: [new BoxShadow(color: Colors.black12,
